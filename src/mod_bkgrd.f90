   ...
   subroutine bkgrd_np_init()
      ...
      !----------------------------
         thorn_prime_ta_0(i,j) = cmplx( &
            ( &
               4.0_rp*sqrt(2.0_rp)*bhs**2*cy*R*sy*(-6.0_rp*cl**4 + bhs**2*R**2*(1.0_rp + cy**2 - sy**2)) &
            )/( &
               2.0_rp*cl**4 + bhs**2*R**2*(1.0_rp + cy**2 - sy**2) &
            )**3 &
            , &
            ( &
               2.0_rp*sqrt(2.0_rp)*bhs*cl**2*sy*(4.0_rp*cl**4 + 3.0_rp*bhs**2*R**2*(-1.0_rp - 3.0_rp*cy**2 + sy**2)) &
            )/( &
               2.0_rp*cl**4 + bhs**2*R**2*(1.0_rp + cy**2 - sy**2) &
            )**3 &
            , &
