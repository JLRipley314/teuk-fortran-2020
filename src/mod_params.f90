...
implicit none
   ...
   integer(ip), parameter :: num_saved_times = 800_ip
   integer(ip), parameter :: nx = 112_ip
   ...
   real(rp), parameter :: horizon = 0.5993992449669514_rp
   real(rp), parameter :: R_max = 1.6683371031859344_rp
   real(rp), parameter :: scd_order_start_time = 21.814718962675716_rp
   integer(ip), parameter :: ny = 40_ip
   real(rp), parameter :: dt = 0.0007174744897959183_rp
   integer(ip), parameter :: nt = 104533_ip
   integer(ip), parameter :: t_step_save = 130_ip
   ...
   character(*), parameter :: output_stem = 'Thu_16_41_bhm0.5_bhs0.49_nx112_nl28_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Thu_16_41_bhm0.5_bhs0.49_nx112_nl28_m_2_2'
   character(*), parameter :: bin_name = 'Thu_16_41_bhm0.5_bhs0.49_nx112_nl28_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Thu_16_41_bhm0.5_bhs0.49_nx112_nl28_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Thu_16_40_bhm0.5_bhs0.49_nx112_nl28_m_2_2/output.txt'
