...
implicit none
   ...
   integer(ip), parameter :: nx = 128_ip
   ...
   real(rp), parameter :: rl_pm1 = 0.010704996224103943_rp
   real(rp), parameter :: ru_pm1 = 0.03568332074701316_rp
   ...
   real(rp), parameter :: rl_nm1 = 0.010704996224103943_rp
   real(rp), parameter :: ru_nm1 = 0.03568332074701316_rp
   ...
   real(rp), parameter :: rl_pm2 = -0.013381245280129931_rp
   real(rp), parameter :: ru_pm2 = 0.013381245280129931_rp
   ...
   real(rp), parameter :: rl_nm2 = -0.013381245280129931_rp
   real(rp), parameter :: ru_nm2 = 0.013381245280129931_rp
   ...
   real(rp), parameter :: scd_order_start_time = -38.364643491633444_rp
   integer(ip), parameter :: ny = 36_ip
   real(rp), parameter :: dt = 0.00054931640625_rp
   integer(ip), parameter :: nt = 91022_ip
   integer(ip), parameter :: t_step_save = 151_ip
   ...
   character(*), parameter :: output_stem = 'Sun_17_43_bhm0.5_bhs0.499_nx128_nl24_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Sun_17_43_bhm0.5_bhs0.499_nx128_nl24_m_2_2'
   character(*), parameter :: bin_name = 'Sun_17_43_bhm0.5_bhs0.499_nx128_nl24_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Sun_17_43_bhm0.5_bhs0.499_nx128_nl24_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Sun_17_41_bhm0.5_bhs0.499_nx128_nl24_m_2_2/output.txt'
