...
implicit none
   ...
   integer(ip), dimension(5), parameter :: scd_m = [0_ip,4_ip,5_ip,-4_ip,-1_ip]
   ...
   character(*), parameter :: output_stem = 'Thu_16_04_bhm0.5_bhs0.35_nx200_nl40_m_2_3'
   character(*), parameter :: output_dir = 'output/Thu_16_04_bhm0.5_bhs0.35_nx200_nl40_m_2_3'
   character(*), parameter :: bin_name = 'Thu_16_04_bhm0.5_bhs0.35_nx200_nl40_m_2_3.run'
   character(*), parameter :: tables_dir = 'output/Thu_16_04_bhm0.5_bhs0.35_nx200_nl40_m_2_3/tables'
