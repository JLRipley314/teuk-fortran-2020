...
implicit none
   ...
   integer(ip), parameter :: pm1_ang = 0_ip
   ...
   integer(ip), dimension(1), parameter :: lin_m = [0_ip]
   integer(ip), dimension(1), parameter :: scd_m = [0_ip]
   integer(ip), dimension(1), parameter :: lin_write_m = [0_ip]
   integer(ip), dimension(1), parameter :: scd_write_m = [0_ip]
   ...
   character(*), parameter :: output_stem = 'Sun_13_36_bhm0.5_bhs0.35_nx48_nl12_m_0_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Sun_13_36_bhm0.5_bhs0.35_nx48_nl12_m_0_2'
   character(*), parameter :: bin_name = 'Sun_13_36_bhm0.5_bhs0.35_nx48_nl12_m_0_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Sun_13_36_bhm0.5_bhs0.35_nx48_nl12_m_0_2/tables'
