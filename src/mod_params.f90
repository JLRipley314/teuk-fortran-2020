...
implicit none
   ...
   character(*), parameter :: initial_data_direction_pm1 = 'outgoing'
   real(rp), parameter :: amp_pm1 = 10.0_rp
   real(rp), parameter :: rl_pm1 = 3.0_rp
   real(rp), parameter :: ru_pm1 = 5.0_rp
   ...
   real(rp), parameter :: scd_order_start_time = 23.62640206390264_rp
   ...
   character(*), parameter :: output_stem = 'Fri_12_15_bhm0.5_bhs0.35_nx64_ny20_nl12_s-2_pm11_pm21'
   character(*), parameter :: output_dir = 'output/Fri_12_15_bhm0.5_bhs0.35_nx64_ny20_nl12_s-2_pm11_pm21'
   character(*), parameter :: bin_name = 'Fri_12_15_bhm0.5_bhs0.35_nx64_ny20_nl12_s-2_pm11_pm21.run'
   character(*), parameter :: tables_dir = 'output/Fri_12_15_bhm0.5_bhs0.35_nx64_ny20_nl12_s-2_pm11_pm21/tables'
