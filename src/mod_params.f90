...
implicit none
   ...
   real(rp), parameter :: scd_order_start_time = 14.431532539796684_rp
   ...
   character(*), parameter :: output_stem = 'Wed_19_15_bhm0.5_bhs0.35_nx64_nl12_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Wed_19_15_bhm0.5_bhs0.35_nx64_nl12_m_2_2'
   character(*), parameter :: bin_name = 'Wed_19_15_bhm0.5_bhs0.35_nx64_nl12_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Wed_19_15_bhm0.5_bhs0.35_nx64_nl12_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Wed_19_13_bhm0.5_bhs0.35_nx64_nl12_m_2_2/output.txt'
