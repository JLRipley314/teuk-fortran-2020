...
implicit none
   ...
   integer(ip), parameter :: num_saved_times = 1800_ip
   ...
   real(rp), parameter :: constraint_damping = 44721.34836965916_rp
   ...
   integer(ip), parameter :: nt = 87111_ip
   ...
   character(*), parameter :: output_stem = 'Thu_15_26_bhm0.5_bhs0.499_nx112_nl28_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Thu_15_26_bhm0.5_bhs0.499_nx112_nl28_m_2_2'
   character(*), parameter :: bin_name = 'Thu_15_26_bhm0.5_bhs0.499_nx112_nl28_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Thu_15_26_bhm0.5_bhs0.499_nx112_nl28_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Thu_15_24_bhm0.5_bhs0.499_nx112_nl28_m_2_2/output.txt'
