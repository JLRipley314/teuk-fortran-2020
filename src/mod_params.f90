...
implicit none
   ...
   real(rp), parameter :: rl_pm1 = 0.6_rp
   real(rp), parameter :: ru_pm1 = 1.6_rp
   ...
   real(rp), parameter :: rl_nm1 = 0.6_rp
   real(rp), parameter :: ru_nm1 = 1.6_rp
   ...
   real(rp), parameter :: scd_order_start_time = 26.04406307439852_rp
   integer(ip), parameter :: ny = 40_ip
   real(rp), parameter :: dt = 0.00054931640625_rp
   integer(ip), parameter :: nt = 113777_ip
   integer(ip), parameter :: t_step_save = 189_ip
   ...
   character(*), parameter :: output_stem = 'Sat_13_24_bhm0.5_bhs0.499_nx128_nl28_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Sat_13_24_bhm0.5_bhs0.499_nx128_nl28_m_2_2'
   character(*), parameter :: bin_name = 'Sat_13_24_bhm0.5_bhs0.499_nx128_nl28_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Sat_13_24_bhm0.5_bhs0.499_nx128_nl28_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Sat_13_22_bhm0.5_bhs0.499_nx128_nl28_m_2_2/output.txt'
