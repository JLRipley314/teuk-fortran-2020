...
implicit none
   ...
   integer(ip), dimension(4), parameter :: scd_m = [0_ip,1_ip,2_ip,-2_ip]
   integer(ip), dimension(4), parameter :: lin_write_m = [2_ip,3_ip,-3_ip,-2_ip]
   integer(ip), dimension(4), parameter :: scd_write_m = [0_ip,1_ip,2_ip,-2_ip]
   ...
   character(*), parameter :: output_stem = 'Sat_12_02_bhm0.5_bhs0.35_nx64_nl16_m_2_3'
   character(*), parameter :: output_dir = 'output/Sat_12_02_bhm0.5_bhs0.35_nx64_nl16_m_2_3'
   character(*), parameter :: bin_name = 'Sat_12_02_bhm0.5_bhs0.35_nx64_nl16_m_2_3.run'
   character(*), parameter :: tables_dir = 'output/Sat_12_02_bhm0.5_bhs0.35_nx64_nl16_m_2_3/tables'
