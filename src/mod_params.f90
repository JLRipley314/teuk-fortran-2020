...
implicit none
   ...
   character(*), parameter :: initial_data_direction = 'outgoing'
   character(*), parameter :: initial_data_type = 'compact_bump'
   real(rp), parameter :: amp_pm = 0.1_rp
   real(rp), parameter :: rl_pm = 1.0_rp
   ...
   integer(ip), parameter :: t_step_save = 76_ip
   ...
   character(*), parameter :: output_stem = 'Fri_14_56_bhm0.5_bhs0.35_nx64_ny24_nl16_s-2_lpm2_lnm2_pm1'
   character(*), parameter :: output_dir = 'output/Fri_14_56_bhm0.5_bhs0.35_nx64_ny24_nl16_s-2_lpm2_lnm2_pm1'
   character(*), parameter :: bin_name = 'Fri_14_56_bhm0.5_bhs0.35_nx64_ny24_nl16_s-2_lpm2_lnm2_pm1.run'
   character(*), parameter :: tables_dir = 'output/Fri_14_56_bhm0.5_bhs0.35_nx64_ny24_nl16_s-2_lpm2_lnm2_pm1/tables'
