...
implicit none
   ...
   character(*), parameter :: walltime = '16:00:00'
   ...
   real(rp), parameter :: scd_order_start_time = 7.281135318768486_rp
   integer(ip), parameter :: ny = 32_ip
   real(rp), parameter :: dt = 0.0009765625_rp
   integer(ip), parameter :: nt = 76800_ip
   integer(ip), parameter :: t_step_save = 128_ip
   ...
   character(*), parameter :: output_stem = 'Wed_00_24_bhm0.5_bhs0.49_nx96_nl20_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Wed_00_24_bhm0.5_bhs0.49_nx96_nl20_m_2_2'
   character(*), parameter :: bin_name = 'Wed_00_24_bhm0.5_bhs0.49_nx96_nl20_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Wed_00_24_bhm0.5_bhs0.49_nx96_nl20_m_2_2/tables'
