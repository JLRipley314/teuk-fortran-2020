...
implicit none
   ...
   real(rp), parameter :: evolve_time = 120.0_rp
   ...
   real(rp), parameter :: rl_pm1 = 1.05_rp
   real(rp), parameter :: ru_pm1 = 2.0_rp
   ...
   real(rp), parameter :: rl_nm1 = 1.05_rp
   real(rp), parameter :: ru_nm1 = 2.0_rp
   ...
   real(rp), parameter :: scd_order_start_time = 7.964334241515934_rp
   integer(ip), parameter :: ny = 24_ip
   real(rp), parameter :: dt = 0.00140625_rp
   integer(ip), parameter :: nt = 42666_ip
   ...
   character(*), parameter :: output_stem = 'Sun_00_28_bhm0.5_bhs0.35_nx80_nl12_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Sun_00_28_bhm0.5_bhs0.35_nx80_nl12_m_2_2'
   character(*), parameter :: bin_name = 'Sun_00_28_bhm0.5_bhs0.35_nx80_nl12_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Sun_00_28_bhm0.5_bhs0.35_nx80_nl12_m_2_2/tables'
