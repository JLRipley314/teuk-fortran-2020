...
implicit none
   ...
   integer(ip), parameter :: nt = 22755_ip
   integer(ip), parameter :: t_step_save = 75_ip
   ...
   character(*), parameter :: output_stem = 'Sat_13_57_bhm0.5_bhs0.35_nx64_nl16_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Sat_13_57_bhm0.5_bhs0.35_nx64_nl16_m_2_2'
   character(*), parameter :: bin_name = 'Sat_13_57_bhm0.5_bhs0.35_nx64_nl16_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Sat_13_57_bhm0.5_bhs0.35_nx64_nl16_m_2_2/tables'
   character(*), parameter :: output_file = '/mnt/grtheory/tf-out/Sat_13_56_bhm0.5_bhs0.35_nx48_nl12_m_2_2/output.txt'
