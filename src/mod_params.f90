...
implicit none
   ...
   integer(ip), parameter :: num_saved_times = 400_ip
   ...
   real(rp), parameter :: rl_pm1_0 = -4.0_rp
   real(rp), parameter :: ru_pm1_0 = 4.0_rp
   ...
   real(rp), parameter :: rl_nm1_0 = -4.0_rp
   real(rp), parameter :: ru_nm1_0 = 4.0_rp
   ...
   real(rp), parameter :: rl_pm1 = -3.426857400022861_rp
   real(rp), parameter :: ru_pm1 = 3.426857400022861_rp
   real(rp), parameter :: rl_nm1 = -3.426857400022861_rp
   real(rp), parameter :: ru_nm1 = 3.426857400022861_rp
   ...
   real(rp), parameter :: scd_order_start_time = 15.825749644548146_rp
   integer(ip), parameter :: ny = 36_ip
   real(rp), parameter :: dt = 0.0009765625_rp
   integer(ip), parameter :: nt = 51200_ip
   ...
   character(*), parameter :: output_stem = 'Mon_15_41_bhm0.5_bhs0.35_nx96_nl24_m_2_2'
   character(*), parameter :: output_dir = '/mnt/grtheory/tf-out/Mon_15_41_bhm0.5_bhs0.35_nx96_nl24_m_2_2'
   character(*), parameter :: bin_name = 'Mon_15_41_bhm0.5_bhs0.35_nx96_nl24_m_2_2.run'
   character(*), parameter :: tables_dir = '/mnt/grtheory/tf-out/Mon_15_41_bhm0.5_bhs0.35_nx96_nl24_m_2_2/tables'
