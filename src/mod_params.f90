...
implicit none
   ...
   real(rp), parameter :: rl_pm1 = 1.0_rp
   real(rp), parameter :: ru_pm1 = 2.0_rp
   integer(ip), parameter :: l_ang_nm1 = 3_ip
   ...
   real(rp), parameter :: scd_order_start_time = 7.96123913640602_rp
   ...
   character(*), parameter :: output_stem = 'Thu_15_22_bhm0.5_bhs0.35_nx64_ny24_nl12_s-2_pm12_pm21'
   character(*), parameter :: output_dir = 'output/Thu_15_22_bhm0.5_bhs0.35_nx64_ny24_nl12_s-2_pm12_pm21'
   character(*), parameter :: bin_name = 'Thu_15_22_bhm0.5_bhs0.35_nx64_ny24_nl12_s-2_pm12_pm21.run'
   character(*), parameter :: tables_dir = 'output/Thu_15_22_bhm0.5_bhs0.35_nx64_ny24_nl12_s-2_pm12_pm21/tables'
