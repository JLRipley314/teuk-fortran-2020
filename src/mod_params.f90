...
implicit none
   ...
   integer(ip), parameter :: l_ang_pm = 0_ip
   real(rp), parameter :: amp_nm = 10.0_rp
   real(rp), parameter :: rl_nm = -1.5_rp
   real(rp), parameter :: ru_nm = 1.5_rp
   integer(ip), parameter :: l_ang_nm = 0_ip
   integer(ip), parameter :: pm_ang = 0_ip
   integer(ip), parameter :: psi_spin = 0_ip
   integer(ip), parameter :: psi_boost = 0_ip
   ...
   character(*), parameter :: output_stem = 'Tue_11_19_bhm0.5_bhs0.35_nx48_ny16_nl16_s0_lpm0_lnm0_pm0'
   character(*), parameter :: output_dir = 'output/Tue_11_19_bhm0.5_bhs0.35_nx48_ny16_nl16_s0_lpm0_lnm0_pm0'
   character(*), parameter :: bin_name = 'Tue_11_19_bhm0.5_bhs0.35_nx48_ny16_nl16_s0_lpm0_lnm0_pm0.run'
   character(*), parameter :: tables_dir = 'output/Tue_11_19_bhm0.5_bhs0.35_nx48_ny16_nl16_s0_lpm0_lnm0_pm0/tables'
